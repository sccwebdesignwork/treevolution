...
?><!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><link rel="stylesheet" href="../assets/css/treevolution-v6-3.css"><title>Quote request | Treevolution</title></head><body class="simple-page"><main class="message-card"><img src="../assets/branding/treevolution-logo.svg" alt="Treevolution"><h1><?=e($status)?></h1><p><a class="btn primary" href="../">Back to website</a></p></main></body></html>