...
function project_page_html(array $story): string {
    ...
    $schema = [
        ...
        'author' => ['@type' => 'Organization', 'name' => 'Treevolution', 'url' => 'https://treevolution.uk/'],
        'publisher' => ['@type' => 'Organization', 'name' => 'Treevolution', 'url' => 'https://treevolution.uk/'],
        'about' => $category,
        'contentLocation' => ['@type' => 'Place', 'name' => $location ?: 'Sussex'],
        'image' => array_map(fn($p) => 'https://treevolution.uk/' . ltrim((string)$p, '/'), $images),
    ];
    $crumb = [
        '@context' => 'https://schema.org', '@type' => 'BreadcrumbList', 'itemListElement' => [
            ['@type'=>'ListItem','position'=>1,'name'=>'Home','item'=>'https://treevolution.uk/'],
            ['@type'=>'ListItem','position'=>2,'name'=>'Our work','item'=>'https://treevolution.uk/our-work/'],
    ...
    return '<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover">'
        ...
        . '<meta name="twitter:card" content="summary_large_image"><meta name="theme-color" content="#00b140"><link rel="icon" href="../../../favicon.ico"><link rel="stylesheet" href="../../../assets/css/site.css?v=20260812-0715">'
