...
<nav class="portal-nav" aria-label="Client portal"><a href="index.php">Dashboard</a><a href="manage.php">Updates</a><a aria-current="page" href="performance.php">Performance</a><a href="logout.php">Sign out</a></nav>
</div></header>
