...
<nav class="portal-nav" aria-label="Client portal"><a aria-current="page" href="index.php">Dashboard</a><a href="manage.php">Updates</a><a href="performance.php">Performance</a><a href="logout.php">Sign out</a></nav>
</div></header>
...
<a class="portal-action-card" href="add.php"><span class="portal-action-number">02</span><div><p>Website content</p><h2>Add completed job</h2><span>Publish a project story with up to four optimised photographs.</span></div><b aria-hidden="true">→</b></a>
<a class="portal-action-card" href="manage.php"><span class="portal-action-number">03</span><div><p>Website content</p><h2>Manage updates</h2><span>Edit or remove existing client-created project posts.</span></div><b aria-hidden="true">→</b></a>
...
<article class="portal-panel"><p class="portal-kicker">Content guidance</p><h2>Projects that help customers — and search visibility.</h2><p>For each completed job, describe the tree, the issue, what Treevolution did and the outcome. Use a town or area, never a customer’s exact address.</p><a class="portal-text-link" href="add.php">Add a project <span aria-hidden="true">→</span></a></article>
